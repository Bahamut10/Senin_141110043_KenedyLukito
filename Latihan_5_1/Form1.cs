    ...
    public partial class Form1 : Form
    {
        ...
        private void richTextBox1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if(richTextBox1.SelectionFont!=null)
            {
                ...
                bckgrdColor.Text = richTextBox1.SelectionBackColor.Name == richTextBox1.BackColor.Name ? "Transparent" : richTextBox1.SelectionBackColor.Name;
        ...
        {
            get { return richTextBox1.BackColor.Name=="Window"?"Transparent":richTextBox1.BackColor.Name; }
            set { richTextBox1.BackColor = Color.FromName(value); }
        }
        ...
        private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
        {
            ...
            if (Clipboard.ContainsText(TextDataFormat.Rtf)==false)
            {
                pasteToolStripMenuItem.Enabled = false;
            }
            else
